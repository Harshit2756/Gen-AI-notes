...
message_history: list = [system_message]
...
while True:
    ...
    while True:
        ...
        parsed_candidate = response.choices[0].message.parsed
        assert parsed_candidate is not None, "Failed to parse OpenAI response"
        parsed_result: MyOutputFormat = parsed_candidate
        ...
        if parsed_result.step == "TOOL":
            tool_to_call: str = parsed_result.tool or ""
            tool_input: str = parsed_result.input or ""
